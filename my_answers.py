...
class NeuralNetwork(object):
    ...
    def update_weights(self, delta_weights_i_h, delta_weights_h_o, n_records):
        ...
        '''
        con = (self.lr/ n_records)
        self.weights_hidden_to_output += con * delta_weights_h_o  # update hidden-to-output weights with gradient descent step
        self.weights_input_to_hidden += con * delta_weights_i_h   # update input-to-hidden weights with gradient descent step
